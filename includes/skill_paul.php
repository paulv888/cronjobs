...
function HelpIntent($request, $session, $response) {
    ...
    $response->respond("You can ask or tell Paul anyting" .
        "For example, Ayner is blondie in" .
        "Now, what can I help you with?")
     ->reprompt("<speak> I'm sorry I didn't understand that. You can say things like, " .
        "Paul, my tea glass is empty <break time=\"0.2s\" /> " .
        "Paul, what is for dinner tonight <break time=\"0.2s\" /> " .
        "Now, what can I help you with? </speak>");
...
function LaunchRequest($request, $session, $response) {
    ...
    $response->respond("<speak> Welcome to Paul interface, <break time=\"0.3s\" />Please state the nature of your emergency?</speak>")
     ->reprompt("<speak> I'm sorry I didn't understand that. You can say things like, " .
        "Paul, my tea glass is empty <break time=\"0.2s\" /> " .
        "Paul, what is for dinner tonight <break time=\"0.2s\" /> " .
        "Now, what can I help you with? </speak>");
