	...
	<table class="<?php echo $this->list->class;?>" id="list_<?php echo $this->table->renderid;?>" >
		...
		foreach ($this->rows as $groupedBy => $group) :
			...
			<tbody class="fabrik_groupdata">
				...
				<tr class="lazyLoad">
					<td class="lazyLoad" colspan="<?php echo count($this->headings)?>">
						<div class="lazyLoad">
							Loading...
						</div>
					</td>
...
jQuery(document).ready(function() {
   var timer = setInterval(function() {
      //console.log(++i);
      if ("Fabrik" in window && typeof Fabrik.getBlock('list_<?php echo $this->table->renderid;?>').id != 'undefined') {
         //console.log("Done:"+"Fabrik.blocks.<?php echo $this->table->renderid;?>");
         clearInterval(timer);
         Fabrik.getBlock('list_<?php echo $this->table->id; ?>').updateRows();
      }
    }, 400);
